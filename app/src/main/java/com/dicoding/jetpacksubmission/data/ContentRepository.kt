...
//import com.kylix.submissionbajp3.model.remote.response.TvShowModelResponse as TvShowModelResponse1
//
//open class ContentRepository private constructor(
...
//        return object : NetworkBoundResource<List<TvShowModel>, List<TvShowModelResponse1>>(executors) {
//
...
//            }
//
//            override fun createCall(): LiveData<APIResponse<List<TvShowModelResponse1>>>? {
//                return null
//            }
//
//            override fun saveCallResult(data: List<TvShowModelResponse1>) {
//
//            }
//        }.asLiveData()
//    }
...
//        return object : NetworkBoundResource<TvShowModel, TvShowModelResponse1>(executors) {
//
...
//            }
//
//            override fun createCall(): LiveData<APIResponse<TvShowModelResponse1>>? {
//                return null
//            }
//
//            override fun saveCallResult(data: TvShowModelResponse1) {
//
//            }
//        }.asLiveData()
//    }
...
//        return object : NetworkBoundResource<PagedList<TvShowModel>, List<TvShowModelResponse1>>(executors) {
//
...
//
//        remoteRepository.getMovieList(object : RemoteRepository.GetMovieListCallback {
...
//
//        remoteRepository.getMovieById(movieId, object : RemoteRepository.GetMovieByIdCallback {
...
//
//        remoteRepository.getTvShowList(object : RemoteRepository.GetTvShowListCallback {
//            override fun onTvShowReceived(tvShowModelResponseList: List<com.kylix.submissionbajp3.model.remote.response.TvShowModelResponse>) {
...
//
//        remoteRepository.getTvShowById(tvShowId, object :RemoteRepository.GetTvShowByIdCallback {
//            override fun onTvShowReceived(tvShowModelResponse: TvShowModelResponse1) {
//                val tvShow = TvShowModel(
...
//
//        fun getInstance(local: LocalRepository, remote: RemoteRepository, appExecutors: AppExecutors): DataRepository? {
//            if (INSTANCE == null) {
