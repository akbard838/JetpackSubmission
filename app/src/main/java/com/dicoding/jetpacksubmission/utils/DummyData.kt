...
//object DummyData {
//
//    fun generateDummyMovieResponses(): List<MovieItem> = listOf(
//        MovieItem(
//            id = 337404,
//            title = "Cruella",
...
//
//
//    fun generateDummyTvShowResponses(): List<TvShowItem> = listOf(
//        TvShowItem(
//            id = 84958,
...
//            voteAverage = 7.2,
//            genres = listOf(
//                GenreItem(10767, "Talk"),
//                GenreItem(35, "Comedy"),
//                GenreItem(10763, "News")
//            )
//        ),
//        TvShowItem(
//            id = 1433,
...
//    )
//
//    fun generateDummyMovies(): List<Content> {
//        val movies = ArrayList<Content>()
//
//        generateDummyMovieResponses().map {
//            movies.add(it.toContent())
//        }
//
//        return movies
//    }
//
//    fun generateDummyTvShows(): List<Content> {
//        val tvShows = ArrayList<Content>()
//
//        generateDummyTvShowResponses().map {
//            tvShows.add(it.toContent())
//        }
//
//        return tvShows
//    }
